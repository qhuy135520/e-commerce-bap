...
export default function ForgotPasswordForm({ handleSubmit, t, forgotPasswordSchema }) {
  return (
    <ConfigProvider
      theme={{
        components: {
      ...
      >
        <Form layout="vertical">
          <Form.Item label="Email" name="email">
            <Input type="email" name="email" placeholder={t("forgotPassword.form.placeholder")} suffix="@" />
          </Form.Item>
